...
outputs:
- {id: ASYNCAPB_clock.outFreq, value: 360 MHz}
- {id: AUDPLL_clock.outFreq, value: 12 MHz}
...
- {id: MAIN_clock.outFreq, value: 360 MHz}
- {id: MCAN0_clock.outFreq, value: 360 MHz}
- {id: MCAN1_clock.outFreq, value: 360 MHz}
- {id: SYSPLL_clock.outFreq, value: 360 MHz}
- {id: SYSTICK_clock.outFreq, value: 72 MHz}
...
- {id: MCAN1_OUTPUT_ENDI, value: Enabled}
...
- {id: SYSCON.AUDPLL_BYPASS.sel, value: SYSCON.AUDPLLCLKSEL}
...
- {id: SYSCON.FXCLKSEL0.sel, value: SYSCON.FROHFCLKDIV}
...
- {id: SYSCON.SYSTICKCLKDIV.scale, value: '5', locked: true}
...
void BOARD_BootClockRUN(void)
{
    ...
    POWER_SetVoltageForFreq(360000000U);             /*!< Set voltage for the one of the fastest clock outputs: ASYNCAPB clock output */
    ...
    CLOCK_SetClkDiv(kCLOCK_DivSystickClk, 5U, false);                  /*!< Set SYSTICKCLKDIV divider to value 5 */
