...
extern  void board_sleep(int len);
...
#define BOARD_LED1_GPIO BOARD_INITPINS_LED9_GPIO
#define BOARD_LED1_GPIO_PORT BOARD_INITPINS_LED9_PORT
#define BOARD_LED1_GPIO_PIN BOARD_INITPINS_LED9_PIN


#define BOARD_LED2_GPIO BOARD_INITPINS_LED8_GPIO
#define BOARD_LED2_GPIO_PORT BOARD_INITPINS_LED8_PORT
#define BOARD_LED2_GPIO_PIN BOARD_INITPINS_LED8_PIN


#define BOARD_LED3_GPIO BOARD_INITPINS_LED7_GPIO
#define BOARD_LED3_GPIO_PORT BOARD_INITPINS_LED7_PORT
#define BOARD_LED3_GPIO_PIN BOARD_INITPINS_LED7_PIN

#define BOARD_LED4_GPIO BOARD_INITPINS_LED6_GPIO
#define BOARD_LED4_GPIO_PORT BOARD_INITPINS_LED6_PORT
#define BOARD_LED4_GPIO_PIN BOARD_INITPINS_LED6_PIN
#endif
...
#define LED4_TOGGLE() \
    GPIO_PortToggle(BOARD_LED4_GPIO, BOARD_LED4_GPIO_PORT, 1U << BOARD_LED4_GPIO_PIN) /*!< Toggle on target LED4 */

#define PHY_RESET_SET(output)                                                    \
    GPIO_PinInit(BOARD_INITPINS_PHY_RESET_GPIO, BOARD_INITPINS_PHY_RESET_PORT, BOARD_INITPINS_PHY_RESET_PIN, \
                 &(gpio_pin_config_t){kGPIO_DigitalOutput, (output)}) /*!< Enable target LED4 */


#define PHY_EN_SET(output)                                                    \
    GPIO_PinInit(BOARD_INITPINS_PHY_EN_GPIO, BOARD_INITPINS_PHY_EN_PORT, BOARD_INITPINS_PHY_EN_PIN, \
                 &(gpio_pin_config_t){kGPIO_DigitalOutput, (output)}) /*!< Enable target LED4 */

#define PHY_WAKE_SET(output)                                                    \
    GPIO_PinInit(BOARD_INITPINS_PHY_WAKE_INOUT_GPIO, BOARD_INITPINS_PHY_WAKE_INOUT_PORT, BOARD_INITPINS_PHY_WAKE_INOUT_PIN, \
                 &(gpio_pin_config_t){kGPIO_DigitalOutput, (output)}) /*!< Enable target LED4 */

#define RELAY_INIT(output)                                                    \
