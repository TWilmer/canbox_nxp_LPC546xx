...
#ifndef _LPC54616_FEATURES_H_
#define _LPC54616_FEATURES_H_
...
/* SYSCON module features */
...
#if defined(CPU_LPC54616J256ET180)
...
#elif defined(CPU_LPC54616J512BD100) || defined(CPU_LPC54616J512BD208) || defined(CPU_LPC54616J512ET100)
    /* @brief Pointer to ROM IAP entry functions */
    #define FSL_FEATURE_SYSCON_IAP_ENTRY_LOCATION (0x03000205)
    /* @brief Flash page size in bytes */
    #define FSL_FEATURE_SYSCON_FLASH_PAGE_SIZE_BYTES (256)
    ...
    /* @brief IAP has read extended Flash signature function */
    #define FSL_FEATURE_IAP_HAS_FLASH_EXTENDED_SIGNATURE_READ (1)
#endif /* defined(CPU_LPC54616J256ET180) */
