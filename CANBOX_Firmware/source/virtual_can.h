 ...
 */
#ifndef _USB_CDC_VCAN_H_
#define _USB_CDC_VCAN_H_ 1
...
typedef struct usb_cdc_vcan_info
{
...
typedef struct _usb_cdc_vcan_struct
{
    ...
    usb_cdc_vcan_info_t *usbCdcAcmInfo;       /* CDC ACM information */
