...
#define USB_CDC_VNIC_INTERRUPT_IN_ENDPOINT (3)
#define USB_CDC_VNIC_BULK_IN_ENDPOINT (4)
#define USB_CDC_VNIC_BULK_OUT_ENDPOINT (4)
#define USB_CDC_VNIC_INTERFACE_COUNT (2)
#define USB_CDC_VNIC_COMM_INTERFACE_INDEX (2)
#define USB_CDC_VNIC_DATA_INTERFACE_INDEX (3)
...
/* Configuration, interface and endpoint. FOR CAN */
#define USB_CDC_VCAN_CIC_CLASS (0x02)
#define USB_CDC_VCAN_CIC_SUBCLASS (0x02)
#define USB_CDC_VCAN_CIC_PROTOCOL (0x00)
#define USB_CDC_VCAN_DIC_CLASS (0x0A)
#define USB_CDC_VCAN_DIC_SUBCLASS (0x00)
#define USB_CDC_VCAN_DIC_PROTOCOL (0x00)

#define USB_CDC_VCAN_INTERFACE_COUNT (1)
...
#define USB_CDC_VCAN_DIC_ENDPOINT_COUNT (2)

#define USB_CDC_VCAN_DIC_BULK_IN_ENDPOINT (5)
#define USB_CDC_VCAN_DIC_BULK_OUT_ENDPOINT (5)

/* Packet size. */
#define HS_CDC_VCAN_INTERRUPT_IN_PACKET_SIZE (16)
#define FS_CDC_VCAN_INTERRUPT_IN_PACKET_SIZE (16)
#define HS_CDC_VCAN_INTERRUPT_IN_INTERVAL (0x07) /* 2^(7-1) = 8ms */
#define FS_CDC_VCAN_INTERRUPT_IN_INTERVAL (0x08)


#define HS_CDC_VCAN_BULK_IN_PACKET_SIZE (512)
#define FS_CDC_VCAN_BULK_IN_PACKET_SIZE (64)
#define HS_CDC_VCAN_BULK_OUT_PACKET_SIZE (512)
#define FS_CDC_VCAN_BULK_OUT_PACKET_SIZE (64)
