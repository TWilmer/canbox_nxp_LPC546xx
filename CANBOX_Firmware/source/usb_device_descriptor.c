...
usb_device_endpoint_struct_t g_cdcVnicCicEp[USB_CDC_VNIC_ENDPOINT_CIC_COUNT] = {
    {
        USB_CDC_VNIC_INTERRUPT_IN_ENDPOINT | (USB_IN << 7U),
        USB_ENDPOINT_INTERRUPT,
        FS_CDC_VNIC_INTERRUPT_IN_PACKET_SIZE,
        FS_CDC_VNIC_INTERRUPT_IN_INTERVAL,
    },
};
...
usb_device_endpoint_struct_t g_cdcVnicDicEp[USB_CDC_VNIC_ENDPOINT_DIC_COUNT] = {
    {
        USB_CDC_VNIC_BULK_IN_ENDPOINT | (USB_IN << 7U),
        USB_ENDPOINT_BULK,
        FS_CDC_VNIC_BULK_IN_PACKET_SIZE,
        0U,
    },
...
usb_device_interfaces_struct_t g_cdcVnicIfs[USB_CDC_VNIC_INTERFACE_COUNT] = {
    {USB_CDC_VNIC_CIC_CLASS, USB_CDC_VNIC_CIC_SUBCLASS, USB_CDC_VNIC_CIC_PROTOCOL, USB_CDC_VNIC_COMM_INTERFACE_INDEX,
     g_cdcVnicCommunicationInterface, sizeof(g_cdcVnicCommunicationInterface) / sizeof(usb_device_interface_struct_t)},
    {USB_CDC_VNIC_DIC_CLASS, USB_CDC_VNIC_DIC_SUBCLASS, USB_CDC_VNIC_DIC_PROTOCOL, USB_CDC_VNIC_DATA_INTERFACE_INDEX,
     g_cdcVnicDataInterface, sizeof(g_cdcVnicDataInterface) / sizeof(usb_device_interface_struct_t)},
};
...
/**
 * CAN Interfaces stuff
 */



/* Define endpoint for data class */
usb_device_endpoint_struct_t g_cdcVcanDicEndpoints[USB_CDC_VCAN_DIC_ENDPOINT_COUNT] = {
    {
        USB_CDC_VCAN_DIC_BULK_IN_ENDPOINT | (USB_IN << 7U),
        USB_ENDPOINT_BULK,
        FS_CDC_VCAN_BULK_IN_PACKET_SIZE,
        0U,
    },
    {
        USB_CDC_VCAN_DIC_BULK_OUT_ENDPOINT | (USB_OUT << 7U),
        USB_ENDPOINT_BULK,
        FS_CDC_VCAN_BULK_OUT_PACKET_SIZE,
        0U,
    },
};
...
/* Define interface for data class */
usb_device_interface_struct_t g_cdcVcanDicInterface[] = {{0,
                                                          {
                                                              USB_CDC_VCAN_DIC_ENDPOINT_COUNT,
                                                              g_cdcVcanDicEndpoints,
                                                          },
                                                          NULL}};


/* Define interfaces for virtual com */
usb_device_interfaces_struct_t g_cdcVcanInterfaces[USB_CDC_VCAN_INTERFACE_COUNT] = {
    {USB_CDC_VCAN_DIC_CLASS, USB_CDC_VCAN_DIC_SUBCLASS, USB_CDC_VCAN_DIC_PROTOCOL, USB_CDC_VCAN_DIC_INTERFACE_INDEX,
     g_cdcVcanDicInterface, sizeof(g_cdcVcanDicInterface) / sizeof(usb_device_interface_struct_t)},
};


/* Define configurations for virtual com */
usb_device_interface_list_t g_cdcVcanInterfaceList[USB_DEVICE_CONFIGURATION_COUNT] = {
    {
        USB_CDC_VCAN_INTERFACE_COUNT,
        g_cdcVcanInterfaces,
    },
};

/* Define class information for virtual com */
usb_device_class_struct_t g_UsbDeviceCdcVcomConfig[3] = {
    {
    ...
    {
    		g_cdcVnicInterfaceList,
			kUSB_DeviceClassTypeCdc,
        USB_DEVICE_CONFIGURATION_COUNT,
    },
    {
    	g_cdcVcanInterfaceList,
        kUSB_DeviceClassTypeCdc,
        USB_DEVICE_CONFIGURATION_COUNT,
    },
...
#define DESC_LEN2 (USB_DESCRIPTOR_LENGTH_CONFIGURE + \
...
uint8_t g_UsbDeviceConfigurationDescriptor[] = {
    ...
    USB_SHORT_GET_LOW(DESC_LEN),
    USB_SHORT_GET_HIGH(DESC_LEN),
    ...
    USB_SHORT_GET_HIGH(FS_CDC_VCOM_BULK_OUT_PACKET_SIZE), 0x00, /* The polling interval value is every 0 Frames */
	 ...
	 /* Communication Interface Descriptor */
	    ...
	    USB_CDC_VNIC_ENDPOINT_CIC_COUNT,
		USB_CDC_VNIC_CIC_CLASS+0,
		USB_CDC_VNIC_CIC_SUBCLASS, 0xFF,
	    0x00, /* Interface Description String Index*/
	    ...
	    USB_DESCRIPTOR_TYPE_CDC_CS_INTERFACE, /* CS_INTERFACE Descriptor Type */
	    USB_CDC_UNION_FUNC_DESC,
		USB_CDC_VNIC_COMM_INTERFACE_INDEX,        /* The interface number of the Communications or Data Class interface  */
		USB_CDC_VNIC_DATA_INTERFACE_INDEX,                                 /* Interface number of subordinate interface in the Union  */
	    ...
	    /* Data Interface Descriptor */
	    USB_DESCRIPTOR_LENGTH_INTERFACE, USB_DESCRIPTOR_TYPE_INTERFACE, USB_CDC_VCAN_DIC_INTERFACE_INDEX, 0x00,
	    USB_CDC_VCAN_DIC_ENDPOINT_COUNT, USB_CDC_VCAN_DIC_CLASS, USB_CDC_VCAN_DIC_SUBCLASS, USB_CDC_VCAN_DIC_PROTOCOL,
	    0x00, /* Interface Description String Index*/

	    /*Bulk IN Endpoint descriptor */
	    USB_DESCRIPTOR_LENGTH_ENDPOINT, USB_DESCRIPTOR_TYPE_ENDPOINT, USB_CDC_VCAN_DIC_BULK_IN_ENDPOINT | (USB_IN << 7U),
	    USB_ENDPOINT_BULK, USB_SHORT_GET_LOW(FS_CDC_VCAN_BULK_IN_PACKET_SIZE),
	    USB_SHORT_GET_HIGH(FS_CDC_VCAN_BULK_IN_PACKET_SIZE), 0x00, /* The polling interval value is every 0 Frames */

	    /*Bulk OUT Endpoint descriptor */
	    USB_DESCRIPTOR_LENGTH_ENDPOINT, USB_DESCRIPTOR_TYPE_ENDPOINT, USB_CDC_VCAN_DIC_BULK_OUT_ENDPOINT | (USB_OUT << 7U),
	    USB_ENDPOINT_BULK, USB_SHORT_GET_LOW(FS_CDC_VCAN_BULK_OUT_PACKET_SIZE),
	    USB_SHORT_GET_HIGH(FS_CDC_VCAN_BULK_OUT_PACKET_SIZE), 0x00, /* The polling interval value is every 0 Frames */
...
usb_status_t USB_DeviceSetSpeed(usb_device_handle handle, uint8_t speed)
{
    ...
    while (ptr1 < ptr2)
    {
        if (ptr1->common.bDescriptorType == USB_DESCRIPTOR_TYPE_ENDPOINT)
        {
            if (USB_SPEED_HIGH == speed)
            {
                ...
                else if ((USB_CDC_VNIC_INTERRUPT_IN_ENDPOINT ==
                          (ptr1->endpoint.bEndpointAddress & USB_ENDPOINT_NUMBER_MASK)) &&
                         ((ptr1->endpoint.bEndpointAddress & USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_MASK) ==
                          USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_IN))
                {
                    ...
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(HS_CDC_VNIC_INTERRUPT_IN_PACKET_SIZE,
                         ...
                         ((ptr1->endpoint.bEndpointAddress & USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_MASK) ==
                          USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_IN))
                {
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(HS_CDC_VNIC_BULK_IN_PACKET_SIZE,
                                                       ptr1->endpoint.wMaxPacketSize);
                }
                         ...
                         ((ptr1->endpoint.bEndpointAddress & USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_MASK) ==
                          USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_OUT))
                {
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(HS_CDC_VNIC_BULK_OUT_PACKET_SIZE,
                                                       ptr1->endpoint.wMaxPacketSize);
                }

                               else if ((USB_CDC_VCAN_DIC_BULK_IN_ENDPOINT ==
                                         (ptr1->endpoint.bEndpointAddress & USB_ENDPOINT_NUMBER_MASK)) &&
                                        ((ptr1->endpoint.bEndpointAddress & USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_MASK) ==
                                         USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_IN))
                               {
                                   USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(HS_CDC_VCAN_BULK_IN_PACKET_SIZE,
                                                                      ptr1->endpoint.wMaxPacketSize);
                               }
                               else if ((USB_CDC_VCAN_DIC_BULK_OUT_ENDPOINT ==
                                         (ptr1->endpoint.bEndpointAddress & USB_ENDPOINT_NUMBER_MASK)) &&
                                        ((ptr1->endpoint.bEndpointAddress & USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_MASK) ==
                                         USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_OUT))
                               {
                                   USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(HS_CDC_VCAN_BULK_OUT_PACKET_SIZE,
                                                                      ptr1->endpoint.wMaxPacketSize);
                               }
                else
                {
                          ...
                          USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_IN))
                {
                    ...
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(FS_CDC_VNIC_INTERRUPT_IN_PACKET_SIZE,
                         ...
                         ((ptr1->endpoint.bEndpointAddress & USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_MASK) ==
                          USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_IN))
                {
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(FS_CDC_VNIC_BULK_IN_PACKET_SIZE,
                                                       ptr1->endpoint.wMaxPacketSize);
                }
                else if ((USB_CDC_VNIC_BULK_OUT_ENDPOINT ==
                          (ptr1->endpoint.bEndpointAddress & USB_ENDPOINT_NUMBER_MASK)) &&
                         ((ptr1->endpoint.bEndpointAddress & USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_MASK) ==
                          USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_OUT))
                {
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(FS_CDC_VNIC_BULK_OUT_PACKET_SIZE,
                                                       ptr1->endpoint.wMaxPacketSize);
                }
                                        ...
                                        ((ptr1->endpoint.bEndpointAddress & USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_MASK) ==
                                         USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_IN))
                               {
                                   USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(FS_CDC_VCAN_BULK_IN_PACKET_SIZE,
                                                                      ptr1->endpoint.wMaxPacketSize);
                               }
                               else if ((USB_CDC_VCAN_DIC_BULK_OUT_ENDPOINT ==
                                         (ptr1->endpoint.bEndpointAddress & USB_ENDPOINT_NUMBER_MASK)) &&
                                        ((ptr1->endpoint.bEndpointAddress & USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_MASK) ==
                                         USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_OUT))
                               {
                                   USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(FS_CDC_VCAN_BULK_OUT_PACKET_SIZE,
                                                                      ptr1->endpoint.wMaxPacketSize);
                               }
                else
                {
    ...
    for (int i = 0; i < USB_CDC_VNIC_ENDPOINT_DIC_COUNT; i++)
    {
        if (USB_SPEED_HIGH == speed)
        {
            if (g_cdcVnicDicEp[i].endpointAddress & USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_MASK)
            {
            	g_cdcVnicDicEp[i].maxPacketSize = HS_CDC_VNIC_BULK_IN_PACKET_SIZE;
            }
            else
            {
        ...
        else
        {
            if (g_cdcVnicDicEp[i].endpointAddress & USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_MASK)
            {
            	g_cdcVnicDicEp[i].maxPacketSize = FS_CDC_VNIC_BULK_IN_PACKET_SIZE;
            }
            else
            {
       ...
       for (int i = 0; i < USB_CDC_VCAN_DIC_ENDPOINT_COUNT; i++)
       {
           if (USB_SPEED_HIGH == speed)
           {
               if (g_cdcVcanDicEndpoints[i].endpointAddress & USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_MASK)
               {
            	   g_cdcVcanDicEndpoints[i].maxPacketSize = HS_CDC_VCAN_BULK_IN_PACKET_SIZE;
               }
               else
               {
            	   g_cdcVcanDicEndpoints[i].maxPacketSize = HS_CDC_VCAN_BULK_OUT_PACKET_SIZE;
               }
           }
           else
           {
               if (g_cdcVcanDicEndpoints[i].endpointAddress & USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_MASK)
               {
            	   g_cdcVcanDicEndpoints[i].maxPacketSize = FS_CDC_VCAN_BULK_IN_PACKET_SIZE;
               }
               else
               {
            	   g_cdcVcanDicEndpoints[i].maxPacketSize = FS_CDC_VCAN_BULK_OUT_PACKET_SIZE;
               }
           }
       }
