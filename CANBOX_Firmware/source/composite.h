...
typedef struct _usb_device_composite_struct
{
    ...
    usb_cdc_vnic_t cdcVnic;
    usb_cdc_vcan_struct_t cdcVcan; /* CDC virtual com device structure. */
...
extern usb_status_t USB_DeviceCdcVcanCallback(class_handle_t handle, uint32_t event, void *param);
extern usb_status_t USB_DeviceCdcVcanSetConfigure(class_handle_t handle, uint8_t configure);
extern usb_status_t USB_DeviceCdcVcanInit(usb_device_composite_struct_t *deviceComposite);
/*!
