...
extern usb_status_t USB_DeviceCdcVnicInit(usb_cdc_vnic_t *item);
extern usb_status_t USB_DeviceCdcVnicCallback(class_handle_t handle, uint32_t event, void *param);
extern usb_status_t USB_DeviceCdcVnicSetConfigure(class_handle_t handle, uint8_t configure);
