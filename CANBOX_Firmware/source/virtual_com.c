...
extern usb_device_endpoint_struct_t g_cdcVnicCicEp[];
...
usb_status_t USB_DeviceCdcVcomCallback(class_handle_t handle, uint32_t event, void *param)
{
    ...
    epCbParam = (usb_device_endpoint_callback_message_struct_t *)param;
        ...
        if (handle != g_deviceComposite->cdcVcom.cdcAcmHandle)
        {
        	return error;
        }
...
usb_status_t USB_DeviceCdcVcomSetConfigure(class_handle_t handle, uint8_t configure)
{
    if (USB_COMPOSITE_CONFIGURE_INDEX == configure)
    {
        ...
        g_deviceComposite->cdcVcom.interruptEndpoint = USB_CDC_VCOM_CIC_INTERRUPT_IN_ENDPOINT;
        g_deviceComposite->cdcVcom.interruptEndpointMaxPacketSize = g_cdcVcomCicEndpoints[0].maxPacketSize;

        g_deviceComposite->cdcVcom.bulkInEndpoint = USB_CDC_VCOM_DIC_BULK_IN_ENDPOINT;
        g_deviceComposite->cdcVcom.bulkInEndpointMaxPacketSize = g_cdcVcomDicEndpoints[0].maxPacketSize;

        g_deviceComposite->cdcVcom.bulkOutEndpoint = USB_CDC_VCOM_DIC_BULK_OUT_ENDPOINT;
        g_deviceComposite->cdcVcom.bulkOutEndpointMaxPacketSize = g_cdcVcomDicEndpoints[1].maxPacketSize;

        /* Schedule buffer for receive */
        return USB_DeviceCdcAcmRecv(g_deviceComposite->cdcVcom.cdcAcmHandle, g_deviceComposite->cdcVcom.bulkOutEndpoint,
                             s_currRecvBuf[0], g_deviceComposite->cdcVcom.bulkOutEndpointMaxPacketSize);
...
usb_status_t USB_DeviceCdcVcomInit(usb_device_composite_struct_t *deviceComposite)
{
    g_deviceComposite = deviceComposite;
        ...
        g_deviceComposite->cdcVcom.lineCoding = (uint8_t *)&s_lineCoding[0];
        g_deviceComposite->cdcVcom.abstractState = (uint8_t *)&s_abstractState[0];
        g_deviceComposite->cdcVcom.countryCode = (uint8_t *)&s_countryCode[0];
        g_deviceComposite->cdcVcom.usbCdcAcmInfo = &s_usbCdcAcmInfo[0];
        g_deviceComposite->cdcVcom.currRecvBuf = (uint8_t *)&s_currRecvBuf[0][0];
        ;
        g_deviceComposite->cdcVcom.currSendBuf = (uint8_t *)&s_currSendBuf[0][0];
